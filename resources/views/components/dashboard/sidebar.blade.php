    ...
    <div class="flex-1 flex flex-col overflow-y-auto py-6">
        <nav class="flex-1 px-4 space-y-1">
            ...
            <a href="{{ route('my-applications') }}"
                class="group flex items-center px-4 py-3 text-sm font-bold rounded-full transition {{ request()->routeIs('my-applications') ? 'bg-primary-50 text-primary-600 shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900' }}">
                <svg class="mr-3 shrink-0 h-5 w-5 {{ request()->routeIs('my-applications') ? 'text-primary-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('dashboard.saved-searches') }}"
                class="group flex items-center px-4 py-3 text-sm font-bold rounded-full transition {{ request()->routeIs('dashboard.saved-searches') ? 'bg-primary-50 text-primary-600 shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900' }}">
                <svg class="mr-3 shrink-0 h-5 w-5 {{ request()->routeIs('dashboard.saved-searches') ? 'text-primary-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('dashboard.success-stories.submit') }}"
                class="group flex items-center px-4 py-3 text-sm font-bold rounded-full transition {{ request()->routeIs('dashboard.success-stories.*') ? 'bg-primary-50 text-primary-600 shadow-sm' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900' }}">
                <svg class="mr-3 shrink-0 h-5 w-5 {{ request()->routeIs('dashboard.success-stories.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-gray-500' }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
