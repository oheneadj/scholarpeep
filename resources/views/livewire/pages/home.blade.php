                    ...
                    @foreach($testimonials as $story)
                        <div
                            ...
                            <div class="mb-6 relative">
                                ...
                                <p class="text-gray-600 italic leading-relaxed relative z-10 pl-4">{{ $story->quote }}</p>
                            </div>
                            ...
                            <div class="flex items-center gap-4 border-t border-gray-50 pt-6 mt-2">
                                <div class="relative w-10 h-10 flex-shrink-0">
                                    ...
                                    <div class="absolute -bottom-1 -right-1 bg-white rounded-full p-0.5 shadow-sm">
                                        {{-- Replace with country flag or small icon if available, otherwise just decorative dot
                                        --}}
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 font-medium uppercase tracking-wide">{{ $story->role }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
