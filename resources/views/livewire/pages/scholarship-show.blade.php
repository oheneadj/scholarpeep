            ...
            <main class="lg:col-span-7 space-y-24">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                    <div class="text-center">
                        <p class="text-xs text-gray-400 uppercase tracking-widest mb-4">Advertisement</p>
                        <div class="bg-white rounded-xl p-12 border-2 border-dashed border-gray-200 flex items-center justify-center min-h-[250px]">
                            <div class="text-center">
                                <svg class="w-16 h-16 text-gray-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <p class="text-gray-400 font-medium">Ad Space Available</p>
                                <p class="text-sm text-gray-300 mt-2">728x90 or 300x250</p>
                            </div>
                        </div>
                    </div>
                </div>
